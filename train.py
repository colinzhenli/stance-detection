...
from stance_detection.callback import *
from stance_detection.data.data_module import DataModule
...
def init_model(cfg):
    model = getattr(import_module("stance_detection.model"), cfg.model.model.module)(cfg.model.model, cfg.data, cfg.model.optimizer, cfg.model.lr_decay, None)
    return model
